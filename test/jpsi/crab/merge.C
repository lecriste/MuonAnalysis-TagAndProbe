...
int main() {
  ...
  TString dir = "crab_TnP_fullMC_80X_correctTreeSta"; TString task = "160621_225352" ;
  ...
  if (dir.Contains("MC")) {
    ...
    prefix = "/store/group/phys_muon/lecriste/TnP/JpsiToMuMu_JpsiPt8_TuneCUEP8M1_13TeV-pythia8";
